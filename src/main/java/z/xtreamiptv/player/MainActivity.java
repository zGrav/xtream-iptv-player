        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                ...
                case 3:
                    ...
                    return rootView;
                case 4:
                    List<Category> seriescategories = Collections.emptyList();
                    rootView = inflater.inflate(R.layout.live_categories, container, false);
                    mRecyclerView = (RecyclerView) rootView.findViewById(R.id.my_recycler_view);
                    mRecyclerView.setHasFixedSize(false);
                    mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                    mAdapter = new SeriesCategoriesAdapter(getActivity(), seriescategories);
                    api.getSeriesCategories((SeriesCategoriesAdapter) mAdapter);
                    mRecyclerView.setAdapter(mAdapter);
                    return rootView;
                case 5:
