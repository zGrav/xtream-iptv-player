...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private static final IjkLibLoader sLocalLibLoader = new C09901();
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (player == null || player.mNativeMediaPlayer == 0) {
                DebugLog.m796w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
                return;
            }
            switch (msg.what) {
                case 0:
                ...
                case 100:
                    DebugLog.m790e(IjkMediaPlayer.TAG, "Error (" + msg.arg1 + "," + msg.arg2 + ")");
                ...
                case 200:
                    switch (msg.arg1) {
                        case 3:
                            DebugLog.m792i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            break;
                    }
                ...
                case 10001:
                    ...
                    return;
                default:
                    DebugLog.m790e(IjkMediaPlayer.TAG, "Unknown message type " + msg.what);
                    return;
            }
        }
    }
    ...
    static class C09901 implements IjkLibLoader {
        C09901() {
        }
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m796w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> headers) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        ...
        if (Param.CONTENT.equals(scheme) && "settings".equals(uri.getAuthority())) {
    ...
    public void setScreenOnWhilePlaying(boolean screenOn) {
        if (this.mScreenOnWhilePlaying != screenOn) {
            if (screenOn && this.mSurfaceHolder == null) {
                DebugLog.m796w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
